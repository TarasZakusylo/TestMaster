...
public class AvtorStudent extends JFrame{
	...
	public AvtorStudent(String s) {
		...
		l_Koment.setBounds(46, 168, 483, 52);
		getContentPane().add(l_Koment);
		
		l_Hapka = new JLabel("Ви увійшли як учень / студент");
		...
		l_Hapka.setBounds(23, 0, 626, 135);
		...
		l_Mail.setBounds(35, 245, 214, 31);
		...
		l_Password.setBounds(35, 289, 214, 31);
		...
		b_Vhid.setBounds(25, 333, 475, 31);
		...
		l_Reestrasia.setBounds(12, 428, 483, 52);
		getContentPane().add(l_Reestrasia);
		
		l_Uchen = new JLabel("Увійти як учиталь / викладач");
		...
		l_Uchen.setBounds(12, 479, 483, 32);
		...
		l_fon.setIcon(new ImageIcon("res/fon/AvtorStudent.jpg"));
